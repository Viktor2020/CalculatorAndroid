package com.example.ex2015_07_26.core.matchParser;
...
public class MatchParser {
    ...
    public static double fact(double expression) {
        return (expression <= 0) ? 1 : expression * fact(expression - 1);
    }
